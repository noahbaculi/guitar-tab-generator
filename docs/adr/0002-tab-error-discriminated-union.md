...
> described below (`guitar`, `arrangement`, `invalidInput`) were flattened into 13 specific
> variants, while `parse` was retained. This record is kept for historical context.
