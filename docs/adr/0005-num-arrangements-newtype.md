...
- `TabInput.num_arrangements: u8` stays a plain number on the wire so JS sees a primitive; the lift to `NumArrangements` happens inside `build_arrangement_set`.
